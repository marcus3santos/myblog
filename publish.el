...
(defun me/website-html-preamble (plist)
  ...
  (if (org-export-get-date plist this-date-format)
      (plist-put plist
                 :text (format "Published on %s by %s."
...
(setq org-publish-project-alist
	 ...
	 ;:publishing-directory "/ssh:m3santos@moon.scs.ryerson.ca:~/public_html/public"
         ...
         ;:html-link-home "https://www.cs.ryerson.ca/m3santos/public/"
         ;:html-link-up "https://www.cs.ryerson.ca/m3santos/"
        ...
        ("about"
         ...
         :recursive nil
         :publishing-function org-html-publish-to-html
	 ;:publishing-directory "/ssh:m3santos@moon.scs.ryerson.ca:~/public_html/public/about"
	 ...
	 :publishing-directory "./public/about"
        ...
        ("css"
         :base-directory "./css"
         :base-extension "css"
	 ;:publishing-directory "/ssh:m3santos@moon.scs.ryerson.ca:~/public_html/public/css"
	 ...
	 ;:publishing-directory "/ssh:m3santos@moon.scs.ryerson.ca:~/public_html/public/images"
        ...
        ("assets"
         ...
         :base-extension ,site-attachments
	 ;:publishing-directory "/ssh:m3santos@moon.scs.ryerson.ca:~/public_html/public/assets"
